...
st.markdown(
    ...
    '</div>'
    '<span style="color: #bbb; font-style: italic; margin-top: 6px; margin-bottom: 10px;">The content is entirely AI-generated. Please be sure to verify it carefully<br>Content AI-generated, please discern with care</span>'
    '</div>',
    unsafe_allow_html=True
)
